...
from main.simulateFlow import clear_data, generate_data, get_simulation_result
...
def clear_data_initiate(request):
    ...
    task = clear_data.delay()
    print("job dispatched...")
    return Response({"message": "Clear data initiated", "task": task.id, })
